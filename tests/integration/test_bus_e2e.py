...
async def test_all_event_types_are_publishable(redis):
    ...
    events = [
        ...
        (
            TRAINING_SCRIPT_READY,
            {"job_id": "j1", "script_path": "s.py", "search_space_redis_key": "k"},
        ),
        (
            EPOCH_COMPLETE,
            {"job_id": "j1", "epoch": 1, "train_loss": 0.5, "val_loss": 0.6, "eta_seconds": 100},
        ),
        (
            TRAINING_COMPLETE,
            {
        ...
        (
            DRIFT_ALERT,
            {"job_id": "j1", "psi_score": 0.25, "psi_threshold": 0.2, "window_size": 1000},
        ),
    ]
