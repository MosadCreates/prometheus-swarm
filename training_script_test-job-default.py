"""
Training script for job test-job-default
...
output_dir = os.path.join(_outputs_dir, "test-job-default", "checkpoints")
...
with open(os.path.join(_outputs_dir, "test-job-default", "result.json"), "w") as f:
    json.dump(result, f)
