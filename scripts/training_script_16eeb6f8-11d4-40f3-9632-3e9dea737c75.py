"""
Training script for job 16eeb6f8-11d4-40f3-9632-3e9dea737c75
...
df = pd.read_csv(os.path.join(_data_dir, "tc12_telco_customer_churn.csv"))
target = df.pop("churn_label")
...
output_dir = os.path.join(_outputs_dir, "16eeb6f8-11d4-40f3-9632-3e9dea737c75", "checkpoints")
