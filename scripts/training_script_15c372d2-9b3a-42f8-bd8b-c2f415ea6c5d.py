"""
Training script for job 15c372d2-9b3a-42f8-bd8b-c2f415ea6c5d
...
output_dir = os.path.join(_outputs_dir, "15c372d2-9b3a-42f8-bd8b-c2f415ea6c5d", "checkpoints")
...
with open(os.path.join(_outputs_dir, "15c372d2-9b3a-42f8-bd8b-c2f415ea6c5d", "result.json"), "w") as f:
    json.dump(result, f)
