"""
Training script for job 2bbb13a4-b932-4ca2-ae8a-ad2686315666
...
output_dir = os.path.join(_outputs_dir, "2bbb13a4-b932-4ca2-ae8a-ad2686315666", "checkpoints")
...
with open(os.path.join(_outputs_dir, "2bbb13a4-b932-4ca2-ae8a-ad2686315666", "result.json"), "w") as f:
    json.dump(result, f)
