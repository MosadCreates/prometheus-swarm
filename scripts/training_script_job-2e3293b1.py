"""
Training script for job job-2e3293b1
...
output_dir = os.path.join(_outputs_dir, "job-2e3293b1", "checkpoints")
...
with open(os.path.join(_outputs_dir, "job-2e3293b1", "result.json"), "w") as f:
    json.dump(result, f)
