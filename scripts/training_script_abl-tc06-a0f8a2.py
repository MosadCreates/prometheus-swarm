"""
Training script for job abl-tc06-a0f8a2
...
df = pd.read_csv(os.path.join(_data_dir, "tc06_bank_marketing.csv"))
target = df.pop("y")
...
output_dir = os.path.join(_outputs_dir, "abl-tc06-a0f8a2", "checkpoints")
