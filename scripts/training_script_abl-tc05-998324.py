"""
Training script for job abl-tc05-998324
...
df = pd.read_csv(os.path.join(_data_dir, "tc05_breast_cancer_wisconsin.csv"))
target = df.pop("1")
...
output_dir = os.path.join(_outputs_dir, "abl-tc05-998324", "checkpoints")
