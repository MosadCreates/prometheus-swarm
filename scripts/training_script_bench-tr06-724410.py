"""
Training script for job bench-tr06-724410
...
df = pd.read_csv(os.path.join(_data_dir, "tr06_stock_price.csv"))
target = df.pop("Close")
...
output_dir = os.path.join(_outputs_dir, "bench-tr06-724410", "checkpoints")
