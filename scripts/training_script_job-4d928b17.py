"""
Training script for job job-4d928b17
...
output_dir = os.path.join(_outputs_dir, "job-4d928b17", "checkpoints")
...
with open(os.path.join(_outputs_dir, "job-4d928b17", "result.json"), "w") as f:
    json.dump(result, f)
