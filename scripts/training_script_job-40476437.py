"""
Training script for job job-40476437
...
if _use_optuna:
    ...
    def _objective(trial):
        ...
        params["verbosity"] = 0
        _model = Pipeline(
            [("preprocessor", preprocessor), ("estimator", xgb.XGBClassifier(**params))]
        )
...
neg = (y_train == 0).sum()
pos = (y_train == 1).sum()
estimator = xgb.XGBClassifier(**best_params, scale_pos_weight=float(neg / pos) if pos > 0 else 1.0)
model = Pipeline(
    [
