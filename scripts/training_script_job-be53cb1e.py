"""
Training script for job job-be53cb1e
...
output_dir = os.path.join(_outputs_dir, "job-be53cb1e", "checkpoints")
...
with open(os.path.join(_outputs_dir, "job-be53cb1e", "result.json"), "w") as f:
    json.dump(result, f)
