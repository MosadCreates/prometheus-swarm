"""
Training script for job bench-tc01-7c67c2
...
df = pd.read_csv(os.path.join(_data_dir, "titanic.csv"), encoding="utf-8")
...
output_dir = os.path.join(_outputs_dir, "bench-tc01-7c67c2", "checkpoints")
...
with open(os.path.join(_outputs_dir, "bench-tc01-7c67c2", "result.json"), "w") as f:
    json.dump(result, f)
