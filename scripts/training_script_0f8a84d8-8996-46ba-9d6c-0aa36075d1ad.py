"""
Training script for job 0f8a84d8-8996-46ba-9d6c-0aa36075d1ad
...
output_dir = os.path.join(_outputs_dir, "0f8a84d8-8996-46ba-9d6c-0aa36075d1ad", "checkpoints")
...
with open(os.path.join(_outputs_dir, "0f8a84d8-8996-46ba-9d6c-0aa36075d1ad", "result.json"), "w") as f:
    json.dump(result, f)
