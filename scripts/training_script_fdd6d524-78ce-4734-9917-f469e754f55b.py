"""
Training script for job fdd6d524-78ce-4734-9917-f469e754f55b
...
output_dir = os.path.join(_outputs_dir, "fdd6d524-78ce-4734-9917-f469e754f55b", "checkpoints")
...
with open(os.path.join(_outputs_dir, "fdd6d524-78ce-4734-9917-f469e754f55b", "result.json"), "w") as f:
    json.dump(result, f)
