"""End-to-end pipeline runner for Churn."""
...
async def main():
    ...
    Churn_path = str(get_paths().data / "churn.csv")
    ...
    brief = await scout.run_with_data(
        problem_description="Predict which customers will churn.",
    ...
    env = os.environ.copy()
    env["JOB_ID"] = job_id
    env["OUTPUTS_DIR"] = str(jp.job_dir)
