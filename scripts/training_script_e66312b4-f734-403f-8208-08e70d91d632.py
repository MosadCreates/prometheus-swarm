"""
Training script for job e66312b4-f734-403f-8208-08e70d91d632
...
output_dir = os.path.join(_outputs_dir, "e66312b4-f734-403f-8208-08e70d91d632", "checkpoints")
...
with open(os.path.join(_outputs_dir, "e66312b4-f734-403f-8208-08e70d91d632", "result.json"), "w") as f:
    json.dump(result, f)
