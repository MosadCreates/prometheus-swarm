"""
Training script for job job-70b30830
...
output_dir = os.path.join(_outputs_dir, "job-70b30830", "checkpoints")
...
with open(os.path.join(_outputs_dir, "job-70b30830", "result.json"), "w") as f:
    json.dump(result, f)
