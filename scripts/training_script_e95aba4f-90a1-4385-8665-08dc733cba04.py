"""
Training script for job e95aba4f-90a1-4385-8665-08dc733cba04
...
output_dir = os.path.join(_outputs_dir, "e95aba4f-90a1-4385-8665-08dc733cba04", "checkpoints")
...
with open(os.path.join(_outputs_dir, "e95aba4f-90a1-4385-8665-08dc733cba04", "result.json"), "w") as f:
    json.dump(result, f)
