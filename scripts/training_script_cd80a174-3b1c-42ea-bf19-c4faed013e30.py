"""
Training script for job cd80a174-3b1c-42ea-bf19-c4faed013e30
...
output_dir = os.path.join(_outputs_dir, "cd80a174-3b1c-42ea-bf19-c4faed013e30", "checkpoints")
...
with open(
    os.path.join(_outputs_dir, "cd80a174-3b1c-42ea-bf19-c4faed013e30", "result.json"), "w"
) as f:
    json.dump(result, f)
