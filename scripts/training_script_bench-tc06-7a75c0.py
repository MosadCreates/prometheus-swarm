...
df = pd.read_csv(os.path.join(_data_dir, "tc06_bank_marketing.csv"), encoding="utf-8")
target = df.pop("y")
...
output_dir = os.path.join(_outputs_dir, "bench-tc06-7a75c0", "checkpoints")
...
with open(os.path.join(_outputs_dir, "bench-tc06-7a75c0", "result.json"), "w") as f:
    json.dump(result, f)
