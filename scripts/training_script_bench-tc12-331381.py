"""
Training script for job bench-tc12-331381
...
df = pd.read_csv(os.path.join(_data_dir, "tc12_telco_customer_churn.csv"), sep=",", encoding="utf-8")
target = df.pop("Churn")
...
output_dir = os.path.join(_outputs_dir, "bench-tc12-331381", "checkpoints")
...
with open(os.path.join(_outputs_dir, "bench-tc12-331381", "result.json"), "w") as f:
    json.dump(result, f)
