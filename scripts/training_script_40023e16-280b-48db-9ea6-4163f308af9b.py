"""
Training script for job 40023e16-280b-48db-9ea6-4163f308af9b
...
output_dir = os.path.join(_outputs_dir, "40023e16-280b-48db-9ea6-4163f308af9b", "checkpoints")
...
with open(
    os.path.join(_outputs_dir, "40023e16-280b-48db-9ea6-4163f308af9b", "result.json"), "w"
) as f:
    json.dump(result, f)
