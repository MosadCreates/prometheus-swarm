"""
Training script for job 03965ef3-ac7b-41f3-9ff5-50533e4189f1
...
output_dir = os.path.join(_outputs_dir, "03965ef3-ac7b-41f3-9ff5-50533e4189f1", "checkpoints")
...
with open(
    os.path.join(_outputs_dir, "03965ef3-ac7b-41f3-9ff5-50533e4189f1", "result.json"), "w"
) as f:
    json.dump(result, f)
