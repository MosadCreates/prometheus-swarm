"""
Training script for job b6729f3e-be3c-46b4-babb-ad7687ea5da4
...
output_dir = os.path.join(_outputs_dir, "b6729f3e-be3c-46b4-babb-ad7687ea5da4", "checkpoints")
...
with open(os.path.join(_outputs_dir, "b6729f3e-be3c-46b4-babb-ad7687ea5da4", "result.json"), "w") as f:
    json.dump(result, f)
