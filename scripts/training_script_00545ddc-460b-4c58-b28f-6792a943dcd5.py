"""
Training script for job 00545ddc-460b-4c58-b28f-6792a943dcd5
...
output_dir = os.path.join(_outputs_dir, "00545ddc-460b-4c58-b28f-6792a943dcd5", "checkpoints")
...
with open(os.path.join(_outputs_dir, "00545ddc-460b-4c58-b28f-6792a943dcd5", "result.json"), "w") as f:
    json.dump(result, f)
