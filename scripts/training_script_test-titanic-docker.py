"""
Training script for job test-titanic-docker
...
output_dir = os.path.join(_outputs_dir, "test-titanic-docker", "checkpoints")
...
with open(os.path.join(_outputs_dir, "test-titanic-docker", "result.json"), "w") as f:
    json.dump(result, f)
