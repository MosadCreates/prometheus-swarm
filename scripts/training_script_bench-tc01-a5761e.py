"""
Training script for job bench-tc01-a5761e
...
output_dir = os.path.join(_outputs_dir, "bench-tc01-a5761e", "checkpoints")
...
with open(os.path.join(_outputs_dir, "bench-tc01-a5761e", "result.json"), "w") as f:
    json.dump(result, f)
