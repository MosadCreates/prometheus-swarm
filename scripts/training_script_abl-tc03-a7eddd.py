"""
Training script for job abl-tc03-a7eddd
...
if not False:
    if True:
        estimator = lgb.LGBMClassifier(**best_params, "class_weight": "balanced")
    else:
...
output_dir = os.path.join(_outputs_dir, "abl-tc03-a7eddd", "checkpoints")
