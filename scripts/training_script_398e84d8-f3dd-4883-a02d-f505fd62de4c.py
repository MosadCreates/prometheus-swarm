"""
Training script for job 398e84d8-f3dd-4883-a02d-f505fd62de4c
...
output_dir = os.path.join(_outputs_dir, "398e84d8-f3dd-4883-a02d-f505fd62de4c", "checkpoints")
...
with open(os.path.join(_outputs_dir, "398e84d8-f3dd-4883-a02d-f505fd62de4c", "result.json"), "w") as f:
    json.dump(result, f)
