"""
Training script for job 47224941-6002-4336-b99a-31af34e08dc6
...
output_dir = os.path.join(_outputs_dir, "47224941-6002-4336-b99a-31af34e08dc6", "checkpoints")
...
with open(
    os.path.join(_outputs_dir, "47224941-6002-4336-b99a-31af34e08dc6", "result.json"), "w"
) as f:
    json.dump(result, f)
