"""
Training script for job test-low-conf
...
output_dir = os.path.join(_outputs_dir, "test-low-conf", "checkpoints")
...
with open(os.path.join(_outputs_dir, "test-low-conf", "result.json"), "w") as f:
    json.dump(result, f)
