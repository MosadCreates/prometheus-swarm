...
def select_imbalance_strategy(imbalance_ratio, mission_brief):
    ...
    if imbalance_ratio is None: return "none"
    if imbalance_ratio > 20: return "smote"
    if imbalance_ratio > 5: return "class_weight"
    if imbalance_ratio > 3: return "focal_loss"
    return "none"
